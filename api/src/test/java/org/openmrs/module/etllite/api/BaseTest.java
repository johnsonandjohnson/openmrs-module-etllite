 ...
 * https://code.google.com/p/powermock/issues/detail?id=458 to allow Jacoco agent to run correclty
 * with Power Mock.
 *
 * @author bramak09
 */
...
public class BaseTest {
    ...
    /**
     * Use this method at the beginning of your test case in your //Given part to indicate that you
     * expect the tested method to throw an Exception.
     * <p/>
     * <b>Important :</b> The @Test annotation should NOT contain the expected property for the
     * exception
     *
    ...
    /**
     * Converts the provided object into a JSON string This is used in controller unit tests, but is
     * generic to be used elsewhere as well
     *
    ...
    /**
     * Converts the provided object into a UTF-8 encoded JSON byte array This is used in controller
     * unit tests, but is generic to be used elsewhere as well
     *
     * @param obj to convert
     * @return a json string representation of the object
     * @throws IOException if not able to convert
