...
package org.openmrs.module.etllite.extension.html;
...
public class AdminListTest extends BaseTest {
  @Test
  ...
  public void getTitle_shouldReturnTitle() {
    final String expectedTitleKey = Constants.PROJECT_ID + ".title";
    final AdminList adminList = new AdminList();
  ...
  public void getLinks_shouldReturnCorrectLinks() {
    final String expectedSwaggerUri = Constants.PROJECT_ID + "/swagger/index.html";
    final String expectedSwaggerTitle = Constants.PROJECT_ID + ".refapp.title";
