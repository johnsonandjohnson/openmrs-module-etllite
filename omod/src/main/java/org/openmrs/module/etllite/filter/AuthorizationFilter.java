...
package org.openmrs.module.etllite.filter;
...
public class AuthorizationFilter implements Filter {
  ...
  private void performBasicAuth(String authorization) {
    ...
    try {
      String decoded = new String(Base64.decodeBase64(authorization.replace(BASIC_KEYWORD, "")), StandardCharsets.UTF_8);
      ...
      LOGGER.error("Exception happened during BASIC authorization in AuthorizationFilter.", ex);
    }
  }
}
