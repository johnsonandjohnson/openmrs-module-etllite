...
OpenMRS ETL-Lite Module
==========================

## Description
The ETL Lite module provides functionality related to ETL (Extract, Transform and Load).

SQL queries are used to extract data from a database source. Then the extracted data is transformed into a different data structure
using velocity templates. The last step is to load the transformed data into the OpenMRS database using provided OpenMRS services 
(also using velocity templates).
...
It should display your java version. If you do not have installed Java please follow [Oracle's guide](https://docs.oracle.com/cd/E19182-01/820-7851/inst_cli_jdk_javahome_t/)
to install.
